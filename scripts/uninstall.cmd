@echo off
:: ============================================
:: Blue Prince Head Tracking - Uninstall
:: ============================================
...
:: --- CONFIG BLOCK ---
set "GAME_ID=blue-prince"
set "MOD_DISPLAY_NAME=Blue Prince Head Tracking"
set "MOD_DLLS=BluePrinceHeadTracking.dll CameraUnlock.Core.dll CameraUnlock.Core.Unity.dll"
set "MOD_INTERNAL_NAME=BluePrinceHeadTracking"
...
set "PRESERVE_FILES=BepInEx\config\CameraUnlock.ini BepInEx\config\com.cameraunlock.blueprince.headtracking.cfg"
...
:: own directory.
set "ROOT_EXTRAS=HeadTracking.log"
